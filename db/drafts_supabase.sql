-- Drafts + Versions schema and RPCs for LightCreate Graphic
...
-- 4) RPCs
-- Upsert draft + create new version atomically
...
-- List drafts for user or client
...
-- Restore: duplicate selected version as new latest
